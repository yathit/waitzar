...
class DownloadTemplate(FallbackTemplate):
	template = r'''
		...
		<table align="left" border="0" cellpadding="8" cellspacing="0" style="background-color:#444400; border: 6px solid green; color:white;">
			<tr>
				<td width="100" align="center"style="background-color:#FFFF33; border-right: 3px solid green;"><a style="text-decoration: none;" href="http://waitzar.googlecode.com/files/waitzar_release_1.6.zip">
					<img src="img/wz_icon_zipped.png" border="0"/>
					<br><div style="color: blue; font-size: 12px; position:relative; top:3px;">WaitZar_1.6.zip</div>
				</a></td>
		...
		<br><table align="left" border="0" cellpadding="8" cellspacing="0" style="border: 1px solid green; color:white; margin-top:40px;">
			<tr>
				<td width="100" align="center"style="border-right: 1px solid green;"><a style="text-decoration: none;" href="http://waitzar.googlecode.com/svn/trunk/release_1.6/WaitZar%20User%27s%20Guide.doc">
					<img src="img/wz_icon_guide.png" border="0"/>
					<br><div style="color: #00CCFF; font-size: 12px; position:relative; top:3px;">User's Guide 1.6.exe</div>
				</a></td>
		...
		<br><table align="left" border="0" cellpadding="8" cellspacing="0" style="border: 1px solid green; color:white; margin-top:40px;">
			<tr>
				<td width="100" align="center"style="border-right: 1px solid green;"><a style="text-decoration: none;" href="http://waitzar.googlecode.com/svn/trunk/nightly/WaitZar.exe">
					<img src="img/wz_icon.png" border="0"/>
					<br><div style="color: #00CCFF; font-size: 12px; position:relative; top:3px;">WaitZar.exe</div>
				</a></td>
		...
		<br><table align="left" border="0" cellpadding="8" cellspacing="0" style="border: 1px solid green; color:white; margin-top:40px;">
			<tr>
				<td width="100" align="center"style="border-right: 1px solid green;"><a style="text-decoration: none;" href="http://scim-waitzar.googlecode.com/files/scim-waitzar-1.0.0.deb.zip">
					<img src="img/wz_icon_scim.png" border="0"/>
					<br><div style="color: #00CCFF; font-size: 12px; position:relative; top:3px;">scim-waitzar 1.0.0.zip</div>
				</a></td>
