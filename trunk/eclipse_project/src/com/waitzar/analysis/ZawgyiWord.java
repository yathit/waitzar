...
public class ZawgyiWord {
	...
	public ZawgyiWord(String zawgyiText) {
		...
		if (this.rawText.equals("\u1023"))
			segmentWord("\u1021\u102D");
		else if (this.rawText.equals("\u1024"))
			segmentWord("\u1021\u102E");
		else if (this.rawText.equals("\u1025"))
			segmentWord("\u1021\u102F");
		else if (this.rawText.equals("\u1026") || this.rawText.equals("\u1025\u102E"))
			segmentWord("\u1021\u1030");
		else if (this.rawText.equals("\u1027"))
			segmentWord("\u1021\u1031");
		else if (this.rawText.equals("\u1029") || this.rawText.equals("\u107E\u101E"))
			segmentWord("\u1031\u1021\u102C");
		else if (this.rawText.equals("\u102A") || this.rawText.equals("\u1031\u107E\u101E\u102C\u1039"))
			segmentWord("\u1031\u1021\u102C\u1039");
		else if (this.rawText.equals("\u1031\u101A\u102C\u1000\u1039\u103A\u102C\u1038"))
