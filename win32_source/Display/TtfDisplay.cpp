...
void TtfDisplay::init(HRSRC resource, HGLOBAL dataHandle, HDC currDC, unsigned int defaultColor)
{
}
...
int TtfDisplay::getStringWidth(const std::wstring &str)
{
}

int TtfDisplay::getHeight()
{
}

void TtfDisplay::setColor(unsigned int ARGB)
{
	this->currColor = ARGB;
}
