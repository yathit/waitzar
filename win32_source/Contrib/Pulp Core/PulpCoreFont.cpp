 ...
 */
void PulpCoreFont::init(const std::string& buffer, HDC currDC, const std::wstring& fontFaceName, int pointSize, int devLogPixelsY, unsigned int defaultColor)
{
	PulpCoreImage::init(buffer, currDC);
